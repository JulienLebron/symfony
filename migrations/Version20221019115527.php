 ...
 */
final class Version20221019115527 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, DROP title');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD title VARCHAR(255) NOT NULL, DROP category_id');
    }
}
